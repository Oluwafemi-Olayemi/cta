                        ...
                        <ul class="space-y-4">
                            <li class="bg-white shadow-md rounded-lg p-4">
                                ...
                                <div x-data="{ open: false }">
                                    <div class="py-2">
                                        <x-secondary-button @click="open = !open">View and Apply for Grant</x-secondary-button>
                                    </div>
                                    <div x-show="open" x-transition>
                                        {!! html_entity_decode($conference->full_description) !!}
                                        <div class="d-flex justify-content-end py-2">
                                            <x-primary-button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$conference->id}}">
                                        ...
                                        <form method="POST" action="{{route('grants.update', $conference->id)}}">
                                            @csrf
                                            @method('PUT')
                                        <div class="modal fade" id="exampleModal{{$conference->id}}" tabindex="-1" aria-labelledby="exampleModalLabel{{$conference->id}}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel{{$conference->id}}">{{$conference->name}} Grant Application</h1>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3 form-group">
                                                            <label for="qualiication" class="form-label">Highest Qualification</label>
                                                            <select class="form-control" id="qualification">
                                                                ...
                                                                <option value="masters_coursework">Master's Degree (Coursework)</option>
                                                                <option value="masters_research">Master's Degree (Research)</option>
                                                    ...
                                                    <div class="modal-footer">
                                                        <x-primary-button type="button" class="btn" data-bs-dismiss="modal">Close</x-primary-button>
